      ...
      <div className="card card-hover-effect group h-full flex flex-col">
        <div className="relative">
          ...
          <div className="absolute top-3 left-3 flex flex-col gap-1 z-10">
            {isFeatured && (
              <span className="badge badge-primary shadow-sm text-xs px-2.5 py-1">
                Odporúčané
              </span>
            )}
            {isNew && (
              <span className="badge badge-accent shadow-sm text-xs px-2.5 py-1">
                Nové
              </span>
            )}
          </div>
        ...
        <div className="p-5 flex-grow flex flex-col">
          <div className="flex items-start justify-between">
            <div>
              <h2 className="text-base font-semibold text-gray-800 group-hover:text-primary transition-colors duration-300">{title}</h2>
          ...
          <div className="mt-4 flex flex-wrap gap-3 text-sm text-gray-600">
            {size && (
              <div className="flex items-center bg-gray-50 px-3 py-1.5 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 mr-1.5 text-primary">
