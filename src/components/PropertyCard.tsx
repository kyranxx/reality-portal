      ...
      <div className="card card-hover-effect group h-full flex flex-col">
        <div className="relative">
          ...
          <div className="absolute top-3 right-3 z-10">
            <div className="bg-white/90 backdrop-blur-sm text-xs font-medium py-1 px-2 rounded-full shadow-sm flex items-center">
              {typeIcons[type]}
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10">
            <span className="bg-white/90 backdrop-blur-sm text-primary font-medium py-2 px-4 rounded-full shadow-md transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
              Zobraziť detail
            </span>
          </div>
        </div>
        ...
        <div className="p-5 flex-grow flex flex-col">
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded-lg flex flex-wrap gap-4 text-sm text-gray-700">
            {size && (
