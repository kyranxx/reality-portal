...
export default function HeroSection() {
  ...
  return (
    <div className="relative h-[600px] overflow-hidden bg-gradient-to-r from-primary to-secondary text-white">
      {/* Background overlay */}
      ...
      <div className="container relative z-20 h-full flex items-center">
        <div className="max-w-2xl">
          <div className="animate-fadeIn">
            <span className="inline-block px-4 py-1 bg-white/20 backdrop-blur-sm rounded-full text-sm font-medium mb-4 animate-slideInRight">
              Objavte dokonalý domov
            </span>
            <h1 className="text-4xl md:text-6xl font-bold mb-4 animate-slideInUp">
            ...
            <p className="text-lg md:text-xl opacity-90 mb-8 animate-slideInUp animation-delay-100">
              Najväčšia ponuka nehnuteľností na Slovensku. Jednoduché vyhľadávanie, overení predajcovia a kompletný servis.
            </p>
            <div className="flex flex-wrap gap-4 animate-slideInUp animation-delay-200">
              <a href="/nehnutelnosti" className="btn bg-white text-primary hover:bg-gray-100 shadow-lg hover:shadow-xl transition-all">
          ...
          {/* Property highlight */}
          <div className="mt-12 bg-black/30 backdrop-blur-sm rounded-lg p-4 border border-white/10 animate-slideInUp animation-delay-300 hidden md:block">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <span className="text-amber-300 text-sm font-medium">Odporúčaná nehnuteľnosť</span>
                <h3 className="font-semibold">{currentProperty.title}</h3>
                <p className="text-sm text-white/80">{currentProperty.location} • {currentProperty.price.toLocaleString()} €</p>
              </div>
              <a href={`/nehnutelnosti/${currentProperty.id}`} className="ml-auto bg-white/10 hover:bg-white/20 p-2 rounded-full transition-colors">
