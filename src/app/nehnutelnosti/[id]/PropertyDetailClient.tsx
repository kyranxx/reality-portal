    ...
    return (
      <div className="container my-10">
        <div className="p-6 bg-red-50 rounded-lg border border-red-100 text-center">
          <h2 className="text-xl font-semibold text-red-700 mb-2">{t('errors.errorOccurred', 'An error occurred')}</h2>
    ...
    return (
      <div className="container my-10">
        <div className="p-6 bg-gray-50 rounded-lg border border-gray-100 text-center">
          <h2 className="text-xl font-semibold text-gray-700 mb-2">{t('errors.propertyNotFound', 'Property not found')}</h2>
          <p className="text-gray-600 mb-4">{t('errors.propertyNotFoundMessage', 'The property you are looking for could not be found')}</p>
          <Link href="/nehnutelnosti" className="btn btn-primary">
            {t('errors.backToProperties', 'Back to Properties')}
          </Link>
        </div>
    ...
    <div className="container my-10 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="md:col-span-2 space-y-6">
          <div className="bg-white rounded-lg shadow-sm p-6 border">
            <h2 className="text-2xl font-semibold mb-4">{t('propertyDetail.description', 'Description')}</h2>
          ...
          {property.features && property.features.length > 0 && (
            <div className="bg-white rounded-lg shadow-sm p-6 border">
              <h2 className="text-2xl font-semibold mb-4">{t('propertyDetail.features', 'Features')}</h2>
          ...
          {/* Location */}
          <div className="bg-white rounded-lg shadow-sm p-6 border">
            <h2 className="text-2xl font-semibold mb-4">{t('propertyDetail.location', 'Location')}</h2>
            <div className="aspect-video bg-gray-100 rounded-lg relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-gray-500">{t('propertyDetail.mapPlaceholder', 'Map will be displayed here')}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 border">
            ...
            <div className="mt-8">
              <button className="btn btn-primary w-full mb-3">{t('propertyDetail.contactSeller', 'Contact Seller')}</button>
          ...
          {property.contactName && (
            <div className="bg-white rounded-lg shadow-sm p-6 border">
              <h2 className="text-xl font-semibold mb-4">{t('propertyDetail.contactInformation', 'Contact Information')}</h2>
              <div className="space-y-3">
                <div className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary mr-3 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
      ...
      {similarProperties.length > 0 && (
        <div className="pt-8 border-t">
          <h2 className="text-2xl font-semibold mb-6">{t('propertyDetail.similarProperties', 'Similar Properties')}</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {similarProperties.map((prop) => (
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="font-semibold text-gray-900 group-hover:text-primary transition-colors mb-1">{prop.title}</h3>
                  <p className="text-gray-600 text-sm mb-2">{prop.location}</p>
                  <div className="flex justify-between items-center">
                    <p className="font-bold text-primary">{new Intl.NumberFormat('sk-SK').format(prop.price)} €</p>
